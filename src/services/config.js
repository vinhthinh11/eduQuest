...
export const CREATE_QUESTION_URL = 'http://127.0.0.1:8000/api/admin/question/create';
export const SUBJECTS_URL = 'http://127.0.0.1:8000/api/admin/question/get-subjects';
...
export const DELETE_SUBJECT_URL = 'http://127.0.0.1:8000/api/admin/subject/delete';
