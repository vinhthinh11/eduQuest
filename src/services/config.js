...
export const SUBJECTS_URL = 'http://127.0.0.1:8000/api/get-subjects';
...
export const DELETE_HEAD_JUBJECT_URL =
  ' http://127.0.0.1:8000/api/admin/subject-head/delete';

export const ADMIN_LIST_CHAT_STUDENT =
  'http://127.0.0.1:8000/api/admin/notification/list-student';
export const SEND_NOTIFICATION_STUDENT =
  'http://127.0.0.1:8000/api/admin/notification/send-all-classes';

export const ADMIN_LIST_CHAT_TEACHER =
  'http://127.0.0.1:8000/api/admin/notification/list-teacher';
export const SEND_NOTIFICATION_TEACHER =
  'http://127.0.0.1:8000/api/admin/notification/send-all-teacher';

// export const NOTIFICATION_STUDENT = 'http://127.0.0.1:8000/api/student/notification/{class_id}';
export const NOTIFICATION_STUDENT =
  'http://127.0.0.1:8000/api/student/notification';
...
//// api send notification of teach
export const ALL_NOTIFICATION_STUDENT =
  'http://127.0.0.1:8000/api/teacher/notification/to-student';

export const ALL_NOTIFICATION_ADMIN =
  'http://127.0.0.1:8000/api/teacher/notification/by-admin';

export const SEND_NOTIFICATION_TEACHER_BY_STUDENT =
  'http://127.0.0.1:8000/api/teacher/notification/send';
