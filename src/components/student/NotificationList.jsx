...
import { getAdminChatStudent } from "../../services/apiChatAdmin";
...
const NotificationsPage = () => {
  ...
  const [selectedNotification, setSelectedNotification] = useState(null); // State để lưu thông báo được chọn
  const [openModal, setOpenModal] = useState(false); // State để kiểm soát việc mở và đóng modal
  ...
  // Hàm để mở modal khi một thông báo được nhấp
  const handleNotificationClick = (notification) => {
    setSelectedNotification(notification);
    setOpenModal(true);
  };

  // Hàm để định dạng thời gian thành ngày/tháng/năm
